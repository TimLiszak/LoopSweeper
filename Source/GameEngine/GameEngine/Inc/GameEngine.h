...
{
public:
	virtual void	MenuSelected(string MenuName, INT nMenuId) = 0;
};
...
public:
	...
	void	AddMenuCallback( IMenuCallback* pCallback );
	void	RemoveMenuCallback( IMenuCallback* pCallback );
...
private:
	...
	std::list<IMenuCallback*>		m_MenuCallbacks;
...
inline void CGameEngine::AddMenuCallback( IMenuCallback* pCallback )
{
	m_MenuCallbacks.push_back( pCallback );
}

inline void CGameEngine::RemoveMenuCallback( IMenuCallback* pCallback )
{
